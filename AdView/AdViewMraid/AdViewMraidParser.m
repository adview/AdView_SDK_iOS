...
@implementation AdViewMraidParser
...
- (NSDictionary *)parseCommandUrl:(NSString *)commandUrl
{
    ...
    AdViewLogDebug([NSString stringWithFormat:@"mraid-parser:%@ %@",NSStringFromSelector(_cmd),commandUrl]);
...
- (BOOL)isValidCommand:(NSString *)command
{
    NSArray * kCommands = @[@"createCalendarEvent",
                            @"close",
                            @"expand",
                            @"open",
                            @"playVideo",
