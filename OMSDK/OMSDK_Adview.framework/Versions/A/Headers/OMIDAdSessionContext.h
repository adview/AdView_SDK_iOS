 ...
 */
@interface OMIDAdviewAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDAdviewPartner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDAdviewPartner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDAdviewVerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
